            ...
            <div class="row row-wider">
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        <a href="<?php echo base_url(); ?>admin/profil" class="list-group-item"><i class="fa fa-star"></i> Profil</a>
                        <a class="list-group-item active" href="<?php echo base_url(); ?>admin/profil/update" class="list-group-item"><i class="fa fa-users"></i> Edit Profil</a>
                        <a href="<?php echo base_url(); ?>admin/profil/password" class="list-group-item"><i class="fa fa-key"></i> Ganti Password</a>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group-one-unit margin-bottom-40">
                      <?php echo form_open('admin/profil/update_profil');?>  <div class="row">
                        <div class="col-md-6">
