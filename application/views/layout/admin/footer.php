...
<div class="dev-page-rightbar">
                <div class="rightbar-chat">
                    ...
                    <div class="rightbar-chat-frame-contacts scroll">                        
                        ...
                        <ul class="contacts">
                            <li class="title">Pemberitahuan</li>
                        </ul>
                    </div>
            ...
            <div class="dev-page-footer dev-page-footer-fixed"> <!-- dev-page-footer-closed dev-page-footer-fixed -->
                <ul class="dev-page-footer-controls">
                    ...
                    <li><a href="<?php echo base_url();?>" target="_new" class="tip" title="View Site"><i class="fa fa-life-ring"></i></a></li>
                    <li><a href="<?php echo base_url();?>pages/logout" class="tip" title="Logoff"><i class="fa fa-power-off"></i></a></li>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url();?>assets/js/stream_layers.js"></script>
   ...
   <script type="text/javascript" src="<?php echo base_url();?>assets/js/jquery.blueimp-gallery.min.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url();?>assets/js/jquery.unveil.js"></script>        
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/waypoints.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/js/dev-icon-search.js"></script>
        <!-- ./javascript -->
