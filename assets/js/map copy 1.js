(function(A) {
	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Shop': [
			<?php
            $query = mysql_query('select * from tbl_sekolah');
          if($query === FALSE) { 
...
?>
{
				...
				map_image_url: 'http://mcg.matart.ru/02.Default_Light/html/img/img.png',
			...
			},
			{
				...
				map_image_url: 'http://mcg.matart.ru/02.Default_Light/html/img/img2.png',
			...
			},
			{
				...
				map_image_url: 'http://mcg.matart.ru/02.Default_Light/html/img/img3.png',
				name_point: 'Envato',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: '02.html'
			},
			...
			for (var key in markersData)
				markersData[key].forEach(function (item) {
					marker = new google.maps.Marker({
						...
						map: mapObject,
						icon: 'http://isdnizam.com/skripsiku/assets/img/' + key + '.png',
					});
