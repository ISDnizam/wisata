<script src="https://code.jquery.com/jquery-1.11.1.min.js" ></script><div class="dev-page-content">                    
    <div class="container">
        ...
        <div class="pull-right col-lg-2">
            <br><a href="<?php echo base_url();?>user/gallery/add/<?php echo $id_category;?>" class="btn btn-primary btn-sm">Tambah Foto</a></div>
            ...
            <a href="<?php echo base_url();?>assets/gallery/<?php echo $key->foto;?>" class="gallery-item">   
                ...
                <div class="gallery-item-info">
                   ...
                   <span class="pull-right">
                    <form method="post" action="<?php echo base_url();?>user/gallery/delete/<?php echo $key->id_images;?>">
