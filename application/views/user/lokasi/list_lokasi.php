            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="wrapper">
                    ...
                    <div class="pull-left">  <br><br> 
                        <a href="<?php echo base_url();?>user/wisata/add/<?php echo $category->id;?>" class="btn btn-primary btn-sm">
                                    ...
                                    <?php foreach($data as $row) :?>
                                        ...
                                        <tr>    
                                         ...
                                         <td><a href="<?php echo base_url();?>lokasi/detail/<?php echo $row->id_wisata; ?>"  class="btn btn-primary btn-sm" target="_newtab"><span class="fa fa-eye"></span> </a>
                                            ...
                                            <a href="<?php echo base_url();?>user/wisata/update/<?php echo $row->id_wisata; ?>" class="btn btn-warning btn-sm"><span class="fa fa-edit"></span> </a>
                                            <a href="<?php echo base_url();?>user/wisata/delete/<?php echo $row->id_wisata; ?>" class="btn btn-danger btn-sm" onclick="return konfirmasi()"><span class="fa fa-trash"></span></a>
                                        </td>
                                        </tr>
                                    <?php endforeach; ?>
