...
class Profil extends CI_Controller {
  ...
  public function update()  {
    ...
    $this->load->view('layout/admin/header');
    $this->load->view('layout/admin/sidebar', $data);
    $this->load->view('admin/profil/update',$data);   
    $this->load->view('layout/admin/footer', $data);
  }    
...
public function update_profil()  {         
      ...
      'email' => $this->input->post('email'));  
       ...
       <meta http-equiv='refresh' content='0; url=".base_url()."admin/profil'>"; 
	}
  ...
  public function password()  {
    ...
    $this->load->view('layout/admin/header');
    $this->load->view('layout/admin/sidebar', $data);
    $this->load->view('admin/profil/password',$data);   
    $this->load->view('layout/admin/footer', $data);
  }    
  ...
  function updatepassword(){
    ...
    $passlama = $this->input->post('passwordlama');
      ...
      if(count($hasil->result()) <= 0)
      {
        ...
        <?php
        echo "<meta http-equiv='refresh' content='0; url=".base_url()."admin/profil/password'>";
      }else if($pass!=""){
